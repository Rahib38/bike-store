...
const AllProductsPage = () => {
  ...
  //     if (filter.inStock) params.inStock = filter.inStock === "In Stock" ? "true" : "false";
  ...
  return (
    <div className="container mx-auto mt-5 ">
      ...
      {/* <div className="w-full md:h-[60px] p-2 border rounded-xl flex flex-col md:flex-row justify-between gap-4">
        <div className="relative ml-2">
          <input
            type="search"
            placeholder="Search here"
            className="peer relative h-10 w-full border-b px-4 text-sm text-slate-500 outline-none"
            onChange={handleFilterChange}
          />
        </div>

        <div className="relative mr-2 md:w-60">
